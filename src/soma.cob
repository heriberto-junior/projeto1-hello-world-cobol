IDENTIFICATION DIVISION.
      ...
      *> Converter primeiro parâmetro
           IF WS-PARAMETRO1 NOT = SPACES AND WS-PARAMETRO1(1:LEN1) IS NUMERIC
               MOVE FUNCTION NUMVAL(WS-PARAMETRO1(1:LEN1)) TO WS-NUMERO1
           ELSE
               MOVE 0 TO WS-NUMERO1
           END-IF.
           
      *> Converter segundo parâmetro
           IF WS-PARAMETRO2 NOT = SPACES AND WS-PARAMETRO2(1:LEN2) IS NUMERIC
               MOVE FUNCTION NUMVAL(WS-PARAMETRO2(1:LEN2)) TO WS-NUMERO2
           ELSE
